(function () {
  ...
  async function loadStudents() {
    const { data, error } = await client
      .from('students')
      .select('id, full_name, birth_date, guardian_1_name, guardian_1_cpf, guardian_1_phone, guardian_2_name, guardian_2_phone, active, notes, school_id')
      .eq('school_id', profile.school_id)
      .order('full_name', { ascending: true });
  ...
  async function handleStudentEdit(e) {
    ...
    try {
      ...
      if (!id || !payload.full_name || !payload.birth_date || !payload.guardian_1_name || !payload.guardian_1_cpf || !payload.guardian_1_phone) {
